...
\newcommand{\myName}{Aonghus Lawlor\xspace}
...
\newcommand{\myHOS}{Prof. Neil Hurley\xspace}
...
%  \newfontfamily\texttitlepagefont{Libre Caslon Text}
  \newfontfamily\texttitlepagefont{Cormorant Garamond}
%  \newfontfamily\textthesistitlefont{Libertinus Sans}
...
%\newcommand*{universityfont}{\fontfamily{cabin}\selectfont}
%\newcommand*{universityfont}{\fontfamily{cmss}\selectfont}
  \DeclareTextFontCommand{\textuniversityfont}{
    \fontfamily{Cabin-TLF}\selectfont
  }

  \DeclareTextFontCommand{\texttitlepagefont}{
    \fontfamily{LibreCsln-Regular}\selectfont
  }
